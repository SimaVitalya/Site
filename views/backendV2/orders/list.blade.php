                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                            ...
                            <div class="px-7 py-5" data-kt-user-table-filter="form">
                                <div class="mb-10">
                                    ...
                                    <select class="form-select form-select-solid fw-bold selectOption" data-kt-select2="true" data-placeholder="Select option" data-allow-clear="true" data-kt-user-table-filter="role" data-hide-search="true">
                                        <option></option>
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="button" class="btn btn-primary fw-semibold px-6" onclick="changeStatus(this)">Apply</button>
                                </div>
                            </div>
                        </div>
