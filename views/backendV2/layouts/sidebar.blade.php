             ...
             <div class="menu menu-column menu-rounded menu-sub-indention menu-active-bg fw-semibold my-auto" id="#kt_aside_menu" data-kt-menu="true">
                 ...
                 <div   class="menu-item here show menu-accordion">
                     ...
                     <span class="menu-link">
                         <a class="menu-link active" href="{{ route('backendV2-dashboard') }}">
                             <span class="menu-title">{{ __('backend/dashboard.title') }}</span>
                         </a>
                     </span>
                     <!--end:Menu link-->
                 </div>
                 ...
                 <div  class="menu-item here show menu-accordion">
                     ...
                     <span class="menu-link">
                         <a class="menu-link" href="{{ route('backendV2-jabber') }}">
                             <span class="menu-title">{{ __('backend/jabber.title') }}</span>
                         </a>
                     </span>
                     <!--end:Menu link-->
                 </div>
                 ...
                 <div class="menu-item here show menu-accordion">
                     ...
                     <span class="menu-link">
                         <a class="menu-link" href="{{ route('backendV2-orders') }}">
                             <span class="menu-title">{{ __('backend/orders.title') }}</span>
                         </a>
                     </span>
                     <!--end:Menu link-->
                 </div>
                 ...
                 <div   class="menu-item here show menu-accordion">
                     ...
                     <span class="menu-link">
                         <a class="menu-link" href="{{ route('backendV2-design') }}">
                             <span class="menu-title">{{ __('backend/design.title') }}</span>
                         </a>
                     </span>
                     <!--end:Menu link-->
                 </div>
                 ...
                 <div  class="menu-item here show menu-accordion">
                     ...
                     <span class="menu-link">
                         <a class="menu-link" href="{{ route('backendV2-media') }}">
                             <span class="menu-title">{{ __('backend/media.title') }}</span>
                         </a>
                     </span>
                     <!--end:Menu link-->
                 </div>
                 ...
                 <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                     ...
                     <span class="menu-link">
                         ...
                         <span class="menu-title">{{ __('backend/management.title') }}</span>
