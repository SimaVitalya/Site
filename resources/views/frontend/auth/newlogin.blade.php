              ...
              <div class="col-xxl-6 col-xl-6 col-lg-8">
                 <div class="login__wrapper">
                    ...
                    <div class="login__top text-center">
                       ...
                       <p>Don't have an account yet? <a href="{{ route('register') }}">{{ __('frontend/user.login.create_account') }}</a></p>
                    </div>
                       ...
                       <form method="POST" action="{{ route('login') }}">
                          ...
                          {{-- <div class="login__option-wrapper">
                             <div class="login__option-item mb-15">
                                <a href="#" class="login__option-btn w-100"><img src="{{asset_dir('newdesign/assets/img/icon/google.png')}}" alt=""> Continue with Google</a>
                             </div>
                             <div class="login__option-item">
                                <a href="#" class="login__option-btn w-100"><img src="{{asset_dir('newdesign/assets/img/icon/facebook.png')}}" alt=""> Continue with Facebook</a>
                             </div>
                          </div> --}}
                       </form>
                    </div>
