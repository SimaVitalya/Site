                ...
                <div class="tab-content" id="profile-tabContent">
                	<article class="postbox__item format-image mb-40 transition-3">
						<div class="blog__grid-tag">
	                      <a href="javascript:void(0);">{{ __('frontend/user.tickets.list_tickets') }}</a>
	                      <a href="/ticket/create" class="tp-btn-2 create_ticketss">Create Ticket</a>
	                    </div>
					</article>
                   <div class="tab-pane fade active show" id="nav-ticket" role="tabpanel" aria-labelledby="nav-ticket-tab">
                            	...
                            	@if(count($user_tickets) > 0)
                            		@foreach($user_tickets as $ticket)
										<tr>
											...
											<td><a href="{{ route('ticket-id', $ticket->id) }}">{{ substr($ticket->subject, 0, 255) }}</a></td>
