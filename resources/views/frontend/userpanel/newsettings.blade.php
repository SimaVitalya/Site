               			...
               			<form method="post" action="{{ route('settings-password-change') }}">
							...
							<div class="col-xxl-12 col-xl-12 col-lg-12">
	                            <div class="postbox__comment-input-box">
	                                ...
	                                <div class="postbox__comment-input">
		                               	<input id="settings_current_password" type="password" class="{{ $errors->has('settings_current_password') ? ' is-invalid' : '' }}" name="settings_current_password" value="{{ old('settings_current_password') }}" required>
							...
							<div class="col-xxl-12 col-xl-12 col-lg-12">
	                            <div class="postbox__comment-input-box">
	                                ...
	                                <div class="postbox__comment-input">
		                               	<input id="settings_new_password" type="password" class="{{ $errors->has('settings_new_password') ? ' is-invalid' : '' }}" name="settings_new_password" value="{{ old('settings_new_password') }}" required>
							...
							<div class="col-xxl-12 col-xl-12 col-lg-12">
	                            <div class="postbox__comment-input-box">
	                                ...
	                                <div class="postbox__comment-input">
		                               	<input id="settings_new_password_confirm" type="password" class="{{ $errors->has('settings_new_password_confirm') ? ' is-invalid' : '' }}" name="settings_new_password_confirm" value="{{ old('settings_new_password_confirm') }}" required>
