	       		...
	       		<div class="product__details-info">
	               	...
	               	<div class="product__details-info-bottom ">
						<div class="product__details-info-btn">
							...
							<span id="btcpay" url="{{ route('btcpay') }}"><img src="https://btcpay0.voltageapp.io/img/paybutton/pay.svg" /></span>
						</div>
						<div class="btcform">
						    <form method="POST" action="https://btcpay0.voltageapp.io/api/v1/invoices" class="btcpay-form btcpay-form--block">
                            	<input type="hidden" name="storeId" value="AiKz2Y5NSCjvMhNmqJReYgjTRf5vyn4e8JrfwCZ8pRN4" />
                            	<input type="hidden" name="orderId" value="{{date('Ymd/H-i-s', time())}}" />
                              
                            	<input type="hidden" name="browserRedirect" value="https://laravel-script.net/deposit?orderid={{date('Ymd/H-i-s', time())}}" />
                              ...
                              <div class="btcbtns">
                             <button type="submit"><img src="https://btcpay0.voltageapp.io/img/paybutton/pay.svg" /></button>
						...
						<div class="col-xxl-12 col-xl-12 col-lg-12">
	                        <div class="postbox__comment-input-box">
	                            ...
	                            <div class="postbox__comment-input">
	                               	<input id="coupon_redeem_code" type="text" class="{{ $errors->has('coupon_redeem_code') ? ' is-invalid' : '' }}" name="coupon_redeem_code" value="{{ old('coupon_redeem_code') }}" required autofocus>
	                     ...
	                     <div class="col-xxl-12">
                            <div class="postbox__comment-btn">
                               <button type="submit" class="tp-btn-4 w-100">{{ __('frontend/user.coupon_redeem.submit') }}</button>
                            </div>
                         </div>
					</form>
	            </div>
