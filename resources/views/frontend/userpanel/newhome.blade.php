                ...
                <div class="tab-content" id="profile-tabContent">
                         ...
                         <table class="table">
                            ...
                            <tbody>
                              <tr>
                                  ...
                                  <td>Pending</td>
                                  <td><a href="#" class="link-btn">View <i class="fa-light fa-arrow-right-long"></i> </a></td>
                               </tr>
                               <tr>
                   ...
                   <div class="tab-pane fade" id="nav-notification" role="tabpanel" aria-labelledby="nav-notification-tab">
                     <div class="btn-wrapper w-100">
                        <a style="float: right;" href="{{ route('ticket-create') }}" class="tp-btn-2 active">{{ __('frontend/main.create_ticket') }}</a>
                     </div>
                              ...
                              @if(count($tickets) > 0)
                                 @foreach($tickets as $ticket)
                                    <tr>
                                       ...
                                       <td>
                                          <a href="{{ route('ticket-delete', $ticket->id) }}" class="link-btn">{{ __('frontend/user.tickets.delete') }}</a> | 
                                          <a href="{{ route('ticket-id', $ticket->id) }}" class="link-btn">{{ __('frontend/user.tickets.view') }} 
