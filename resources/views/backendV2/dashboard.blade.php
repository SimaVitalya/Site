                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex flex-column flex-grow-1">
                                ...
                                <div class="mixed-widget-14-chart-new" style="height: 100px"
                                     data-series="{{json_encode($data["products"]["counts"])}}"
                                     data-categories="{{json_encode($data["products"]["dates"])}}"></div>
                                <!--end::Chart-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Stats-->
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex flex-column flex-grow-1">
                                ...
                                <div class="mixed-widget-13-chart-orders" style="height: 100px"
                                     ...
                                     data-categories="{{json_encode($data["orders"]["dates"])}}"></div>
                                <!--end::Chart-->
                            </div>
                            <!--end::Wrapper-->
                            <!--begin::Stats-->
                            ...
                            <div class="timeline-label">
                                ...
                                @foreach(App\Models\UserTicket::orderByDesc('created_at')->limit(4)->get()->all() as $tickets)
                                    ...
                                    <div class="timeline-item">
                                        <!--begin::Label-->
                                        <div class="timeline-label fw-bold text-gray-800 fs-6" style="width: 100px !important;">{{$tickets->created_at->format('d.m.Y')}}</div>
                                        <!--end::Label-->
                                        <!--begin::Badge-->
