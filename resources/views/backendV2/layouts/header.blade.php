    ...
    <div class="d-flex align-items-center flex-shrink-0">
            ...
            <div data-kt-search-element="content"
                ...
                <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="../../demo3/dist/pages/search/horizontal.html" class="btn btn-sm fw-bold btn-primary"
        ...
        <div class="d-flex align-items-center ms-3 ms-lg-4">
            ...
            <div class="btn btn-icon btn-color-gray-700 btn-active-color-primary btn-outline w-40px h-40px"
                ...
                <span class="svg-icon svg-icon-1" data-bs-toggle="modal" data-bs-target="#exampleModal" id="unread-data"
                      onclick="readNotification()">
                        <a href="#" class="notification">
                            <span
                                style="vertical-align: inherit; margin-top: -13px; margin-left: 11px; color:red; position: absolute;">{{
...
@endif
        ...
        <div class="custom-modal modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
             aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content notif">
                    ...
                    <div class="modal-body hideItemDataWithCondition"
                         style="padding-top: 25px !important; text-align: center;">
                    ...
                    <div class="">
                        <div class="card-footer py-5 text-center" id="kt_activities_footer">
                            <button class="btn btn-bg-body text-primary" onclick="clearNotificationByButton()">
                                Clear all notifications <i class="ki-duotone ki-arrow-right fs-3 text-primary"><span
        ...
        {{--                                            <td>{{ \Carbon\Carbon::parse($item->created_at)->format('d.m.y H:i:s') }}</td>                                        </tr>--}}
        {{--                                        @endforeach--}}
        {{--                                    </tbody>--}}
