                         ...
                         <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                             ...
                             <div class="menu-sub menu-sub-accordion">
                                 ...
                                 <div class="menu-item">
                                     ...
                                     <div class="menu-item">
                                         <!--begin:Menu link-->
                                         <a class="menu-link" href="{{ route('backend-management-tickets-with-pageNumber') }}">
                                         <span class="menu-bullet">
                                             <span class="bullet bullet-dot"></span>
                                         </span>
                                             <span class="text-muted">{{ __('backend/management.tickets.title') }}</span>
                         ...
                         <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                             ...
                             <div class="menu-sub menu-sub-accordion">
                                 ...
                                 <div class="menu-item">
                                     ...
                                     <div class="menu-item">
                                         <!--begin:Menu link-->
                                         <a class="menu-link" href="{{ route('backend-management-products-with-pageNumber') }}">
                                         <span class="menu-bullet">
                                             <span class="bullet bullet-dot"></span>
                                         </span>
                                             <span class="text-muted">{{ __('backend/management.products.title') }}</span>
                                     ...
                                     <!--end:Menu item-->
                                     <!--begin:Menu link-->
                                     <a class="menu-link" href="{{ route('backend-management-products-categories-with-pageNumber') }}">
                                         <span class="menu-bullet">
                                             <span class="bullet bullet-dot"></span>
                                         </span>
                         ...
                         <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                             ...
                             <div class="menu-sub menu-sub-accordion">
                                 ...
                                 <div class="menu-item">
                                     ...
                                     <div class="menu-item">
                                         <!--begin:Menu link-->
                                         <a class="menu-link" href="{{ route('backend-management-faqs-with-pageNumber') }}">
                                         <span class="menu-bullet">
                                             <span class="bullet bullet-dot"></span>
                                         </span>
                                             <span class="text-muted">{{ __('backend/management.faqs.title') }}</span>
                                     ...
                                     <!--end:Menu item-->
                                     <!--begin:Menu link-->
                                     <a class="menu-link" href="{{ route('backend-management-faqs-categories-with-pageNumber') }}">
                                         <span class="menu-bullet">
                                             <span class="bullet bullet-dot"></span>
                                         </span>
     ...
     <div class="aside-footer flex-column-auto px-9" id="kt_aside_footer">
         ...
         <div class="d-flex flex-stack">
             ...
             <div class="ms-1">
                 ...
                 <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true" style="text-align: left;">
                     <!--begin::Menu item-->
                     ...
                     <div class="menu-item px-5 my-1">
                         <!-- <a href="{{url('admin/language')}}" class="menu-link px-5">language</a> -->
                            <div class="ms-1">
                                <div class="btn btn-sm btn-icon btn-active-color-primary position-relative me-n2" style="width: 100%;" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-overflow="true" data-kt-menu-placement="top-end">
                                    <!--begin::Svg Icon | path: icons/duotune/coding/cod001.svg-->
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                    ...
                                    @if(count(App\Models\Setting::getAvailableLocales()))                  
                                        @foreach(App\Models\Setting::getAvailableLocales() as $locale)
                                            ...
                                            @endphp
                                                <a href="{{ route('language', $locale) }}" style="display: flex; justify-content: space-between; align-items: center;" class="menu-link px-5">{{ \Lang::get('locale.name', [], $locale) }}<img width = "20px" height = "20px" src = "@php echo  $val; @endphp"></a>
                                            @endforeach
                                     @endif
                                    </div>
