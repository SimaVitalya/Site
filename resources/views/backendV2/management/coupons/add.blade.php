                                ...
                                <form method="post" class="kt-form" action="{{ route('backend-management-coupon-add-form') }}">
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            ...
                                            <div class="form-group mt-5">
                                                <label class="k-checkbox k-checkbox--all k-checkbox--solid" for="coupon_add_is_percent">
                                                    <input type="checkbox"  data-content-visible="false" data-weight-visible="false" id="coupon_add_is_percent" name="coupon_add_is_percent"/>
                                                    <span></span>
...
-->
                                    ...
                                    <div class="kt-portlet__foot mt-5">
                                        <div class="kt-form__actions">
                                            <button type="submit" class="btn btn-wide btn-primary">{{ __('backend/management.coupons.add.submit_button') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
