                                ...
                                <form method="POST" class="kt-form" action="{{ route('backend-management-product-add-form') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first mt-5">
                                            ...
                                            <div class="form-group mt-5">
                                                <label for="product_add_images">{{ __('backend/management.products.images') }}</label>
                                                <input type="file" id="product_add_images" name="product_add_images" class="form-control @if($errors->has('product_add_images')) is-invalid @endif" />
                                            ...
                                            <div class="form-group mt-5">
                                                ...
                                                <input type="text" class="form-control @if($errors->has('product_add_price_in_cent')) is-invalid @endif" id="product_add_price_in_cent" name="product_add_price_in_cent"  value="{{ old('product_add_price_in_cent') }}" />
                                            ...
                                            <div class="form-group mt-5">
                                                ...
                                                <input type="text" class="form-control @if($errors->has('product_add_old_price_in_cent')) is-invalid @endif" id="product_add_old_price_in_cent" name="product_add_old_price_in_cent"  value="{{ old('product_add_old_price_in_cent') }}" />
                                            ...
                                            <div class="form-check form-check-custom form-check-solid form-check-sm mt-5">
                                                <input class="form-check-input"  type="radio" name="product_add_stock_management" id="product_add_stock_management1" checked value="normal" data-content-visible="false" data-weight-visible="false" />
                                            ...
                                            <div class="form-check form-check-custom form-check-solid form-check-sm mt-5">
                                                <input type="radio" class="form-check-input" name="product_add_stock_management" id="product_add_stock_management" value="unlimited" data-content-visible="true" data-weight-visible="false" />
                                            ...
                                            {{-- <div class="form-group">
                                                ...
                                                <input type="file" name="product_add_thumbnail_image" id="product_add_thumbnail_image" accept="image/*">
                                            </div> --}}
                                        </div>
                                    </div>
                                    <div class="kt-portlet__foot mt-5">
                                        <div class="kt-form__actions mt-5">
                                            <button type="submit" class="btn btn-primary">{{ __('backend/management.products.add.submit_button') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
