                                ...
                                <form method="post" class="kt-form" action="{{ route('backend-management-product-edit-form') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            ...
                                            <div class="form-group mt-5">
                                                ...
                                                <textarea class="text-editor form-control @if($errors->has('product_edit_description')) is-invalid @endif" id="product_edit_description" name="product_edit_description" placeholder="{{ __('backend/management.products.description') }}">{{ __(':description', ['description' => $product->description]) }}</textarea>
                                            ...
                                            <div class="form-group mt-5">
                                                <label for="product_edit_image">{{ __('backend/management.products.images') }}</label>
                                                <input type="file" class="form-control @if($errors->has('product_edit_image')) is-invalid @endif" id="product_edit_description" name="product_edit_image"  />
                                    ...
                                    <div class="kt-portlet__foot mt-5">
                                        <div class="kt-form__actions">
                                            <button type="submit" class="btn btn-primary">{{ __('backend/management.products.edit.submit_button') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
