                ...
                <div class="card-body py-4">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users" style="overflow-x: auto; overflow-y: hidden;">
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-80px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1">{{ __('backend/management.faqs.id') }}</th>
                            <th class="min-w-275px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1">{{ __('backend/management.faqs.question') }}</th>
                            <th class="min-w-275px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1">{{ __('backend/management.faqs.category') }}</th>
                            <th class="min-w-275px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1">{{ __('backend/management.faqs.actions') }}</th>
                        </tr>
                        </thead>
                            ...
                            <tr>
                                <td>
                                    <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                        ...
                                        <input class="form-check-input orderCheck" data-id="{{ $faq->id }}" type="checkbox" />
                                    </div>
                                </td>
