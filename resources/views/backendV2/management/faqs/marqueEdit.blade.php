                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                            ...
                            <div class="kt-portlet">
                                ...
                                <form method="post" class="kt-form" action="{{ route('backend-management-marque-edit-update') }}">
                                    @csrf
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="form-group mt-5">
                                                <label for="faq_edit_question">Marque Text</label>
                                                <input type="text" class="form-control" id="faq_edit_question" name="marque_edit_text" placeholder="" value="{{ $marque->marque_text }}" />
                                            </div>
                                        </div>
                                    </div>
