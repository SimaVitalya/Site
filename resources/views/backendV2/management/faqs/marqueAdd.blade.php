                    ...
                    <div class="row">
                        <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                            ...
                            <div class="kt-portlet">
                                ...
                                <form method="post" class="kt-form" action="{{ route('backend-management-marque-adding') }}">
                                    @csrf
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="form-group mt-5">
                                                <!-- <label for="faq_edit_question">Marque Text</label> -->
                                                <input type="text" class="form-control" id="" name="marque_text" placeholder="" value="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="form-group mt-5">
                                               <label for="faq_edit_question">Shop Logo </label>
                                                <input type="text" class="form-control" id="" name="proflie_img" placeholder="" value="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="form-group mt-5">
                                               <label for="faq_edit_question">Shop Banner </label>
                                                <input type="text" class="form-control" id="" name="banner_img" placeholder="" value="" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="form-group mt-5">
                                               <label for="faq_edit_question"> Profile Name </label>
                                                <input type="text" class="form-control" id="" name="profile_names" placeholder="" value="" />
                                            </div>
                                        </div>
                                    </div>
