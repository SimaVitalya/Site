                                ...
                                <form method="post" class="kt-form" action="{{ route('backend-management-faq-edit-form') }}">
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            ...
                                            <div class="form-group mt-5">
                                                ...
                                                <textarea class="text-editor form-control @if($errors->has('faq_edit_answer')) is-invalid @endif" id="faq_edit_answer" name="faq_edit_answer" placeholder="{{ __('backend/management.faqs.answer') }}">{{ \App\Classes\LangHelper::getValue($lang, 'faq', 'answer', $faq->id) ?? (strlen($faq->answer) > 0 ? ($faq->answer) : '') }}</textarea>
                                    ...
                                    <div class="kt-portlet__foot mt-5">
                                        <div class="kt-form__actions mt-5">
                                            <button type="submit" class="btn btn-primary">{{ __('backend/management.faqs.edit.submit_button') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
