                ...
                <div class="card-body py-4">
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users" style="overflow-x: auto; overflow-y: hidden;">
                        ...
                        <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-55px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1">{{ __('backend/orders.table.id') }}</th>
                            <th class="min-w-85px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1">{{ __('backend/orders.table.product') }}</th>
                            <th class="min-w-85px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1">{{ __('backend/orders.table.date') }}</th>
                            <th class="min-w-85px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1">{{ __('backend/orders.table.delivery_method') }}</th>
                            <th class="min-w-85px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1">{{ __('backend/orders.table.notes') }}</th>
                            <th class="min-w-85px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1">{{ __('backend/orders.table.status') }}</th>
                            <th class="min-w-85px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1">{{ __('backend/orders.table.amount') }}</th>
                            <th class="min-w-85px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1" colspan="1">{{ __('backend/orders.table.actions') }}</th>
                        </tr>
                        </thead>
                        ...
                        @foreach($orders as $order)
                            <tr>
                                <td>
                                    <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                        <input class="form-check-input orderCheck" data-id="{{ $order->id }}" type="checkbox" />
                                    </div>
                                </td>
