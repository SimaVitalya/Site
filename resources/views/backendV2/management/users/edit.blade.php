                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <a href="{{ route('backend-management-user-tickets', $user->id) }}"
                               class="btn btn-wide btn-bold btn-primary btn-upper" style="margin-bottom:15px">Alle
                                Tickets</a>
                            <a href="{{ route('backend-management-user-orders', $user->id) }}"
                               class="btn btn-wide btn-bold btn-primary btn-upper" style="margin-bottom:15px">Alle
                                Bestellungen</a>
                            <a href="{{ route('shop') }}" class="btn btn-wide btn-bold btn-primary btn-upper"
                               style="margin-bottom:15px">{{ __('backend/management.tickets.go_to_shop') }}</a>
...
{{--                                                 src="{{ asset_dir('admin/assets/media/misc/iconbox_bg.png') }}"--}}
{{--                                                 alt="bg"/>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
                                ...
                                <div class="k-portlet__body k-portlet__body--fluid">
                                    <div class="k-widget-20">
                                        <div class="k-widget-20__title">
                                            ...
                                            <div class="transactions-chart card-rounded-bottom"
                                                 data-x="{{ $chart["transactions"]["x"] }}"
                                                 data-y="{{ $chart["transactions"]["y"] }}"
                            ...
                            <div class="k-portlet k-portlet--height-fluid">
                                ...
                                <div class="k-portlet__body k-portlet__body--fluid">
                                    <div class="k-widget-20">
                                        ...
                                        <!--<img class="k-widget-20__bg" src="{{ asset_dir('admin/assets/media/misc/iconbox_bg.png') }}" alt="bg" />-->
                                            <div class="tickets-chart card-rounded-bottom"
                                                 data-x="{{ $chart["tickets"]["x"] }}"
                                                 data-y="{{ $chart["tickets"]["y"] }}"
                                ...
                                <div class="k-portlet__body k-portlet__body--fluid">
                                    <div class="k-widget-20">
                                        <div class="k-widget-20__title">
                                            ...
                                            <div class="orders-chart card-rounded-bottom"
                                                 data-x="{{ $chart["orders"]["x"] }}"
                                                 data-y="{{ $chart["orders"]["y"] }}"
                        ...
                        <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                            <div class="kt-portlet">
                                ...
                                <form method="post" class="kt-form"
                                      action="{{ route('backend-management-user-edit-form') }}">
                                    @csrf
                                    ...
                                    <div class="kt-portlet__body">
                                        <div class="kt-section kt-section--first">
                                            <div class="form-group mt-5" style="display: none">
                                                <label
                                                    for="user_edit_name">{{ __('backend/management.users.name') }}</label>
                                                <input type="text"
                                            ...
                                            <div class="form-group mt-5" style="display: none">
                                                <label
                                                    for="user_edit_jabber">{{ __('backend/management.users.jabber') }}</label>
                                                <input type="text"
                                    ...
                                    <div class="kt-portlet__foot mt-5">
                                        <div class="kt-form__actions">
                                            <button type="submit"
                                                    class="btn btn-wide btn-primary">{{ __('backend/management.users.edit.submit_button') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="kt-portlet">
                                    ...
                                    <form method="post" class="kt-form"
                                        ...
                                        <div class="kt-portlet__foot mt-5">
                                            <div class="kt-form__actions">
                                                <button type="submit"
                                                        class="btn btn-wide btn-primary">{{ __('backend/management.users.edit.save_button') }}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
