...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="container-xxl" id="kt_content_container">
        ...
        <div class="card">
            ...
            <!--end::Card header-->
            <!--begin::Form-->
            <form method="POST" action="{{ route('backend-design-form') }}" id="kt_project_settings_form" class="form">
                @csrf
                <!--begin::Card body-->
                <div class="card-body p-9">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-xl-9 fv-row">
                            <input id="logo" name="logo" class=" form-control-solid form-control" value="{{ App\Models\Setting::get('theme.logo') }}" />
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-xl-9 fv-row">
                            <input id="favicon" name="favicon" class=" form-control-solid form-control" value="{{ App\Models\Setting::get('theme.favicon') }}" />
                        </div>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-xl-9 fv-row">
                            <input id="background" name="background" class=" form-control-solid form-control" value="{{ App\Models\Setting::get('theme.background') }}" />
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-xl-9 fv-row">
                            <input id="pattern" name="pattern" class=" form-control-solid form-control" value="{{ App\Models\Setting::get('theme.color1') }}" />
