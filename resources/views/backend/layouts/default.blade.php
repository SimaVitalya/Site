						...
						<div class="k-container k-content-wrapper  k-grid k-grid--ver" id="k_content_wrapper">
							...
							<div class="k-content	k-grid__item k-grid__item--fluid k-grid k-grid--hor" id="k_content">
								...
								@if (\Session::has('errorMessage'))
									<div style="display: flex ;align-items: center;justify-content: center" class="alert alert-danger fade show" role="alert">
								...
								@if (\Session::has('successMessage'))
									<div class="alert alert-success fade show " style="display: flex ;align-items: center;justify-content: center" role="alert">
										<div class="alert-text">
