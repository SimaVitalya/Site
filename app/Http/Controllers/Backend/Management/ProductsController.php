                ...
                if ($request->get('product_edit_id')) {
                    ...
                    if ($product != null) {
                        ...
                        $validator = \Illuminate\Support\Facades\Validator::make($request->all(), [
                            ...
                            'product_edit_price_in_cent' => 'required|regex:/^\d+(\.\d{1,2})?$/',
                            'product_edit_interval' => 'integer|min:1',
                            'product_edit_old_price_in_cent' => 'required|regex:/^\d+(\.\d{1,2})?$/',
        ...
        public function addProductForm(Request $request)
        {
            if ($request->getMethod() == 'POST') {
                $validator = Validator::make($request->all(), [
                    ...
                    'product_add_price_in_cent' => 'required|regex:/^\d+(\.\d{1,2})?$/',
...
//                    $price_in_cent = $request->input('product_add_price_in_cent') / 100;
