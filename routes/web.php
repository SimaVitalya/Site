...
// Dashboard
Route::get('admin', 'Backend\DashboardController@showDashboard')->name('backend-dashboard')->middleware('auth');Route::post('admin/dashboard/change-status', 'Backend\DashboardController@changeStatus')->name('change-status');
